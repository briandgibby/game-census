...
- [x] Repair the historical empty-upgrade catalog foreign key and retain secret-free unexpected-error diagnostics. [Before: 4 failed](evidence/p3-key-repair-before.txt), [after: 26 passed](evidence/p3-key-repair-after.txt), [full suite: 471 passed](evidence/p3-key-repair-suite.txt), [verified local restore](evidence/p3-key-repair-restore.txt), [live repair walkthrough](walkthrough.md#p3-authenticated-catalog-validation--2026-09-07). Group D. FR-05, NFR-01, NFR-02.
...
- [x] Implement and verify bounded cohort policy: typed hysteresis/exploration, canonical adoption and tracking ends, direct plan/apply, runtime consumers, quota admission, stopped/reopened coverage and verified restore. [Cohort increment](walkthrough.md#p3-cohort-increment--2026-09-07), [468-test suite](evidence/p3-cohort-suite-final.txt), [browser evidence](evidence/p3-cohort-browser-first.txt). Live next-cohort acceptance remains separate. Inventory D. FR-05, NFR-01.
...
- [x] Validate authenticated `steam_catalog_v2` against Steam with the locally configured key. [One-page live output](evidence/p3-key-repair-live.txt) records one successful source request, one retained capture and 1,000 entries; [catalog status](evidence/p3-key-repair-status.txt) records cursor 65980. The scan is deliberately partial and the completed watermark remains unset. This satisfies the bounded catalog portion of GC-B04; broader source and next-cohort acceptance remain open. FR-05, NFR-01, NFR-02.
...
- [x] Watch the next bounded cohort and report actual freshness across all tracked app-time, upstream outcomes and resource use before expanding. [P3 canary closeout](walkthrough.md#p3-canary-acceptance--2026-09-09) accepts the fresh epoch-3 window for apps 10/440/570 from `2026-09-08T03:50:44.732006Z` to `2026-09-09T03:50:44.732006Z`: 288 cycles, 1,728 successful requests, 864/864 player occurrences and 99.974% freshness over all 259,200 tracked app-seconds. [Exact output](evidence/p3-closeout/closeout-acceptance.txt) includes per-app gaps and 28 resource samples. Admission is disabled and the heartbeat paused. The earlier interrupted epoch remains unaccepted; enrichment and full-capacity gates remain separate. FR-04, NFR-03.
