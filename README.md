...
Development commits go to `develop`; `main` remains the integration/release boundary. The [P2 integration walkthrough](docs/build-tasks/p2-integration/walkthrough.md) records compatibility evidence. Its completion does not claim a successful 24-hour canary or public-release readiness.
